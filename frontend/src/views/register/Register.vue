<template>
    <div class="col-12">
        ...
        <div class="row">
            <div class="col-12 col-lg-6">
                <div class="form-group">
                    ...
                    <input v-model="email_1" type="email" class="form-control" id="email_1"
            ...
            <div class="col-12 col-lg-6">
                <div class="form-group">
                    ...
                    <input v-model="email_2" type="email" class="form-control" id="email_2"
        ...
        <div class="row mt-2">
            <div class="col-12 col-lg-6">
                <div class="form-group">
                    ...
                    <input v-model="password_1" type="password" class="form-control" id="password_1"
            ...
            <div class="col-12 col-lg-6">
                <div class="form-group">
                    ...
                    <input v-model="password_2" type="password" class="form-control" id="password_2"
        ...
        <div v-if="registerError" class="alert alert-danger">Login Fehlgeschlagen!</div>
...
export default class Register extends Vue {
    ...
    get getLoginButtonClasses() {
        return {
            ...
            "btn-primary": true,
            "btn-block": true,
            "disabled": this.email_1 === '' || this.email_2 === '' || this.password_1 === '' || this.password_2 === ''
        }
    }
